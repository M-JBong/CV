...
#for (i, pub) in data.publications.enumerate() [
  #grid(
    ...
    [
      ...
      #text(size: 9.5pt)[
        #if "journal" in pub and pub.journal != none and pub.journal != "" [
          #text(style: "italic", fill: link-color)[#pub.journal]#if "vol" in pub and pub.vol != none [, #pub.vol] ·
        ]
        #pub.year#if "publisher" in pub and pub.publisher != none [ · #text(style: "italic", fill: rgb("#aaaaaa"))[#pub.publisher]]
