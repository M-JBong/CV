...
const data = {
  ...
  publications: [
    { title:"Secondary Sphere Impact on Organometallic Catalysts in Photochemical CO₂ Reduction: A Comparative Study of Tethering Ligand Lengths with Secondary Coordination", authors:"Min-Jong Bong, Wonjung Lee, Junhyeok Seo*, Ho-Jin Son*", journal:"", publisher:"", year:"In preparation", note:"first author", highlight:false },
    { title:"Unveiling Key Factors Governing the Catalytic Performance of Half-Metallocene Complexes for Photochemical CO₂ Reduction and Hydrogen Production: Relativistic Effects and Charge Delocalization", authors:"Daehan Lee†, Min-Jong Bong†, Seunghwan Cha, Sangheon Jeong, Jung-Min Ji, Won-Jo Jung, Nady A. Fathy, Ho-Jin Son*", journal:"Inorganic Chemistry Frontiers", publisher:"Royal Society of Chemistry", year:"2026", doi:"10.1039/D6QI01142J", note:"co-first author †", highlight:false },
    { title:"A secondary-sphere proton channel accelerating metal–hydride formation in Mn(I) catalysts for selective CO₂-to-formate conversion", authors:"Min-Jong Bong†, Wonjung Lee†, Daehan Lee, Hyunuk Kim, Junhyeok Seo*, Ho-Jin Son*", journal:"Chemical Science", publisher:"Royal Society of Chemistry", year:"2026", vol:"17 (19), 9535–9551", doi:"10.1039/D5SC09412G", note:"first author", highlight:true },
  ...
  awards:[
    { name:"Impressive Poster Award", institution:"14th Asian and Oceanian Photochemistry Conference (APC 2026)", year:"2026", detail:"A Secondary-Sphere Proton Channel Accelerating Metal–Hydride Formation in Mn(I) Catalysts for Selective CO₂-to-Formate Conversion" },
    ...
    { name:"Excellent Research Award", institution:"CURT Research Program, Korea University", year:"2021", detail:"A Hybrid Ru/TiO₂ Catalyst for Photocatalytic CO₂ to CO/Formate Conversion" },
  ],
  gallery:[
                ...
                <div style={{ display:"flex", gap:10 }}>
                  ...
                  <div>
                    ...
                    <p style={{ fontSize:12, color:textS, margin:"0 0 8px" }}>
                      {pub.journal && <><em style={{ color:dark?"#a5b4fc":ACC }}>{pub.journal}</em>{pub.vol?`, ${pub.vol}`:""}{" · "}</>}{pub.year}{pub.publisher && <em style={{ color:dark?"#4b5563":"#9ca3af", fontSize:11 }}> · {pub.publisher}</em>}
                    </p>
